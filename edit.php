...
if (isset($_POST['edit'])){
    ...
    $fechaN = $_POST['fechaN'];
    $papa = $_POST['papa'];
    $query = "UPDATE estudiante SET id=$id, nombre='$nombre', FechaNacimiento='$fechaN', PAPA=$papa 
    WHERE id=$id";
    $result = mysqli_query($conn,$query);
    if (!$result){
            ...
            <div class="card card-body">
                <form action="editar.php?id=<?php echo $id; ?>" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" id="id" name="id" class="form-control" value="<?php echo $id; ?>" require>
                    </div>
                    <div class="mb-3">
                        <label for="nombre" class="form-label">Nombre completo:</label>
                        <input type="text" id="nombre" name="nombre" class="form-control" value="<?php echo $nombre; ?>" require>
                    </div>
                    <div class="mb-3">
                        <label for="fechaN" class="form-label">Fecha de Nacimiento:</label>
                        <input type="date" id="fechaN" name="fechaN" class="form-control" value="<?php echo $fechaN; ?>" require>
                    </div>
                    <div class="mb-3">
